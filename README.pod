...
(https://www.gnu.org/licenses/old-licenses/agpl-2.0.html) and [version 3]
(https://www.gnu.org/copyleft/agpl-3.0.html) of the GNU Affero General Public License for more details.
