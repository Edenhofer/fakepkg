...
by accident or by purpose to e.g. save disk space, it may be usefull to recrete the
...
However you may speed things up a little by using B<-j> or B<XZ_OPT>.
...
B<XZ_OPT> is fully honored and is considered by tar. Common usage scenarios are to
...
termsof the GNU General Public License as published by the Free Software Foundation;
